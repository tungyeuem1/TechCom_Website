    ...
    return (
        ...
        <div className="footer-widgets-wrapper">
            <div className="plane-shape float-bob-y">
                <img src="./src/assets/img/plane-shape.png" alt="img"/>
            </div>
            <div className="container">
                <div className="row">
            ...
            <div className="container">
                <div className="footer-wrapper d-flex align-items-center justify-content-between">
                    ...
                    <ul className="brand-logo wow fadeInRight" data-wow-delay=".5s">
                        <li>
                            <a href="contact.html">
                                <img src="./src/assets/img/visa-logo.png" alt="img"/>
                            </a>
                        </li>
                        <li>
                            <a href="contact.html">
                                <img src="./src/assets/img/mastercard.png" alt="img"/>
                            </a>
                        </li>
                        <li>
                            <a href="contact.html">
                                <img src="./src/assets/img/payoneer.png" alt="img"/>
                            </a>
                        </li>
                        <li>
                            <a href="contact.html">
                                <img src="./src/assets/img/affirm.png" alt="img"/>
                            </a>
                        </li>
                    </ul>
                </div>
